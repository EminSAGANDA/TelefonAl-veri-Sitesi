...
<body>
    ...
    <div class="container" style="width: 65%">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="sepet.php?action=add&id=<?php echo $row["id"]; ?>">
                            ...
                            <div class="product">
                                <img src="<?php echo $row["resim"]; ?>" class="img-responsive">
                                <h5 class="text-info"><?php echo $row["pname"]; ?></h5>
                                <h5 class="text-danger"><?php echo $row["price"]; ?></h5>
                                <input type="text" name="quantity" class="form-control" value="1">
                                <input type="hidden" name="hidden_name" value="<?php echo $row["pname"]; ?>">
                                <input type="hidden" name="hidden_price" value="<?php echo $row["fiyat"]; ?>">
        ...
        <h3 class="title2"> sepet Detayları</h3>
                    ...
                    foreach ($_SESSION["sepet"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="sepet.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
                                        class="text-danger">Eşyayı Sil</span></a></td>
