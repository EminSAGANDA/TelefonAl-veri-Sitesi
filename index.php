    ...
    <div class="header-top">
      <div class="container">
        <div class="row"> 
          <!-- Header Language -->
          <div class="col-xs-6">
            <div class="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#"> <img src="" alt="Türkçe">  <span class="caret"></span> </a>
    ...
    <div class="container">
      <div class="nav-inner">
        ...
        <ul id="nav" class="hidden-xs">
          <li id="nav-home" class="level0 parent drop-menu"><a href="index.html" class="active"><span>Anasayfa</span> </a>
            <ul class="level1">
             
            </ul>
          </li>
          <li class="level0 parent drop-menu"><a href="#"><span>Tüm Ürünler</span> </a>
            <ul class="level1">
              <li class="level1 first"><a href="grid.html"><span>Telefonlar</span></a></li>
              <li class="level1 nav-10-2"> <a href="list.html"> <span>Kulaklıklar</span> </a> </li>
          ...
          <li class="level0 nav-6 level-top parent"> <a href="grid.html" class="level-top"> <span>Markalar</span> </a>
            <div class="level0-wrapper dropdown-6col">
              <div class="level0-wrapper2">
                <div class="nav-block nav-block-center grid12-8 itemgrid itemgrid-4col"> 
                  ...
                  <ul class="level0">
                    <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Samsung</span></a> 
                      <!--sub sub category-->
                    ...
                    <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Apple</span></a> 
                      <!--sub sub category-->
                    ...
                    <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Huawei</span></a> 
                      <!--sub sub category-->
          ...
          <li class="level0 nav-5 level-top first"> <a class="level-top" href="grid.html"> <span>İletişim</span> </a>
            <div class="level0-wrapper dropdown-6col">
              <div class="level0-wrapper2">
          ...
          <li class="level0 parent drop-menu"><a href="grid.html"><span>Kampanyalar </span> 
      ...
      <div class="row">
        <div class="col-lg-8 col-sm-12 col-md-8 wow bounceInUp animated">
          <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
            <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
              <ul>
                <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='images/slider_img_2.jpg'><img src='images/slide2.jpg' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
                ...
                <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='images/slide3.jpg' class="black-text"><img src='images/slide3.jpg'  data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"/>
                  <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-x='45'  data-y='30'  data-endspeed='500'  data-speed='500' data-start='1100' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:2; white-space:nowrap;'></div>
                  <div    class='tp-caption LargeTitle sfl  tp-resizeme ' data-x='45'  data-y='70'  data-endspeed='500'  data-speed='500' data-start='1300' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:3; white-space:nowrap;'></div>
        ...
        <aside class="col-xs-12 col-sm-12 col-md-4 wow bounceInUp animated">
          <div class="RHS-banner">
            <div class="add"><a href="#"><img alt="banner-img" src="images/ayintelefonu.jpg"></a>
              <div class="overlay"><a class="info" href="#">Ayın T</a></div>
            </div>
          </div>
        </aside>
      </div>
              ...
              <div class="slider-items slider-width-col4"> 
                ...
                <div class="item">
                  <div class="col-item">
                    ...
                    <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="products-images/product1.jpg" class="img-responsive" alt="product-image" /> </a>
                      <div class="hover_fly"> <a class="exclusive ajax_add_to_cart_button" href="#" title="Add to cart">
                        <div><i class="icon-shopping-cart"></i><span>sıparıs ıcın ıletışıme gecınız</span></div>
                    ...
                    <div class="info">
                      <div class="info-inner">
                        ...
                        <div class="item-content">
                          ...
                          <div class="price-box">
                            <p class="special-price"> <span class="price"> 45.00 TL</span> </p>
                            <p class="old-price"> <span class="price-sep">-</span> <span class="price"> 50.00 TL </span> </p>
                          </div>
                        </div>
                        <!--item-content--> 
                      </div>
                    ...
                    <div class="info">
                      <div class="info-inner">
                        ...
                        <div class="item-content">
                          ...
                          <div class="price-box"> <span class="regular-price"> <span class="price">422.00 TL</span> </span> </div>
                        </div>
                        <!--item-content--> 
                      </div>
                      <!--info-inner-->
                    ...
                    <div class="info">
                      <div class="info-inner">
                        ...
                        <div class="item-content">
                          ...
                          <div class="price-box"> <span class="regular-price"> <span class="price">50.00 TL</span> </span> </div>
                        </div>
                        <!--item-content--> 
                      </div>
                      <!--info-inner-->
                    ...
                    <div class="info">
                      <div class="info-inner">
                        ...
                        <div class="item-content">
                          ...
                          <div class="price-box">
                            <p class="special-price"> <span class="price"> 35.00 Tl </span> </p>
                            <p class="old-price"> <span class="price-sep">-</span> <span class="price"> 50.00 TL </span> </p>
                          </div>
                        </div>
                        <!--item-content--> 
      ...
      <div id="featured-slider" class="product-flexslider hidden-buttons">
        <div class="slider-items slider-width-col4"> 
          ...
          <div class="item">
            <div class="col-item">
              <div class="sale-label sale-top-right">Sale</div>
              <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="products-images/ip1.jpg" class="img-responsive" alt="a" /> </a>
          ...
          <div class="item">
            <div class="col-item">
              ...
              <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img alt="a" class="img-responsive" src="products-images/ip1.jpg"> </a>
                <div class="actions-links"><span class="add-to-links"> <a title="magik-btn-quickview" class="magik-btn-quickview" href="quick_view.html"><span>quickview</span></a> <a title="Add to Wishlist" class="link-wishlist" href="wishlist.html"><span>Add to Wishlist</span></a> <a title="Add to Compare" class="link-compare" href="compare.html"><span>Add to Compare</span></a></span> </div>
              </div>
              <div class="info">
                <div class="info-inner">
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-4">
          ...
          <ul class="links">
            ...
            <li><a href="#/" title="ARA Terms">Search Terms</a></li>
