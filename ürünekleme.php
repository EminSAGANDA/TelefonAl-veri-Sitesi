                ...
                <div class='row'>
                    <div class='col-md-12'>
                        ...
                        <h1 class='page-subhead-line'>Sitenizi yönetmek için menüyü kullanabilirsiniz. </h1>
                            ...
                            <input type='number' name='stokSayisi' placeholder='Stok sayisi'><br>
							<input type='text' name='kategori_adi' placeholder='Kategori adini giriniz.'><br>
...
if($_POST){
	...
	$ekle = "INSERT INTO urunler (urunAdi, ureticiAdi, urunFiyat, stokSayisi, kategori_adi) VALUES ('$urunAdi', '$ureticiAdi', '$urunFiyat','$stokSayisi', '$kategori_adi')";
